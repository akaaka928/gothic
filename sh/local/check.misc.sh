...
do
	...
	do
		...
		make -j calc CHECK_FUNCTION_CALLS=1 LOCALIZE_I_PARTICLES=1 BRUTE_FORCE_LOCALIZER=1 FACILE_NEIGHBOR_SEARCH=1 CHECK_CALL_MAKE_TREE=1 CHECK_CALL_MAKE_NODE=1 CHECK_CALL_NEIGHBOUR=1 NUM_NTHREADS=$NTHREADS NUM_TSUB=$TSUB USE_WARPSHUFFLE=$USE_WS PREF_SHARED_MEM=$SM_PREF ADOPT_GADGET_TYPE_MAC=0 ADOPT_WS93_TYPE_MAC=1 1>>$LOG 2>>$ERR
		###############################################
