...
#SBATCH --ntasks=128            # number of total MPI processes, set to SLURM_NTASKS
#SBATCH --ntasks-per-socket=64  # number of MPI processes per socket, set to SLURM_NTASKS_PER_SOCKET
