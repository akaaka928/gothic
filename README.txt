...
#################################################################################################
cfg:	parameter sets to describe initial conditions generated by MAGI: "MAny-component Galactic Initial-conditions" generator
host:	hostfiles for MVAPICH2
plt:	gp files for GNUPLOT
sh:	shell scripts
src:	source files
	src/file:	I/O subroutines
	src/init:	initial condition generator; includes MAGI: "MAny-component Galactic Initial-conditions" generator
...
magi:	compile MAGI: "MAny-component Galactic Initial-conditions" generator
