...
{
#   if  !defined(ENABLE_IMPLICIT_SYNC_WITHIN_WARP) && (TSUB_SCAN_VEC4_INC < 32)
  thread_block_tile<TSUB_SCAN_VEC4_INC> tile = tiled_partition<TSUB_SCAN_VEC4_INC>(this_thread_block());
#endif//!defined(ENABLE_IMPLICIT_SYNC_WITHIN_WARP) && (TSUB_SCAN_VEC4_INC < 32)
  Type tmp;
