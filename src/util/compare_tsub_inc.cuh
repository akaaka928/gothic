...
#   if  defined(USE_WARP_REDUCE_FUNC_COMPARE_TSUB_INC) && !defined(ENABLE_WARP_REDUCE_FUNC)
#undef          USE_WARP_REDUCE_FUNC_COMPARE_TSUB_INC
#endif//defined(USE_WARP_REDUCE_FUNC_COMPARE_TSUB_INC) && !defined(ENABLE_WARP_REDUCE_FUNC)
