...
#   if  defined(USE_WARP_REDUCE_FUNCTIONS_COMPARE_TSUB_NWARP_INC) && !defined(ENABLE_WARP_REDUCE_FUNCTIONS)
#undef          USE_WARP_REDUCE_FUNCTIONS_COMPARE_TSUB_NWARP_INC
#endif//defined(USE_WARP_REDUCE_FUNCTIONS_COMPARE_TSUB_NWARP_INC) && !defined(ENABLE_WARP_REDUCE_FUNCTIONS)
