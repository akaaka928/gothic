...
#   if  defined(USE_WARP_REDUCE_FUNCTIONS_SCAN_TSUB_INC) && !defined(ENABLE_WARP_REDUCE_FUNCTIONS)
#undef          USE_WARP_REDUCE_FUNCTIONS_SCAN_TSUB_INC
#endif//defined(USE_WARP_REDUCE_FUNCTIONS_SCAN_TSUB_INC) && !defined(ENABLE_WARP_REDUCE_FUNCTIONS)
