...
int main(int argc, char **argv)
{
  ...
  static  ulong nint[NDST][NARC][NMAX];/**< number of interactions */
  static double time[NDST][NARC][NMAX];/**< elapsed time (second) */
  static PLFLT fstep[NDST][NARC][NMAX];
  static PLFLT fnint[NDST][NARC][NMAX];/**< number of interactions */
  static PLFLT fnips[NDST][NARC][NMAX];/**< number of interactions per second */
