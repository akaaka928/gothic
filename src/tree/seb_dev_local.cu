/*************************************************************************\
 *                                                                       *
                  last updated on 2016/12/06(Tue) 12:56:49
 *                                                                       *
...
(const int lane, volatile real * RESTRICT qq, volatile real * RESTRICT rr, const int idx, pos4seb * RESTRICT seb, dat4seb * RESTRICT mem, int * RESTRICT rank)
{
  //-----------------------------------------------------------------------
...
(const int lane, jnode * RESTRICT pi, pos4seb * RESTRICT pos, real4 * RESTRICT cen, real * RESTRICT qq, real * RESTRICT rr, dat4seb * RESTRICT mem, int * RESTRICT rank
...
(jnode * RESTRICT pi, const pos4seb pos, const real4 cen, real4 * RESTRICT cen2aff, const dat4seb mem, const int rank, real * RESTRICT qq)
{
  //-----------------------------------------------------------------------
  /* compute vector from pos to origin */
  const position org = pi[mem.idx[rank]].pi;
...
(const int lane, jnode * RESTRICT pi, const pos4seb pos, const real4 cen, dat4seb * RESTRICT aff,
 const int rank, const dat4seb mem, volatile real * RESTRICT qq, volatile real * RESTRICT rr)
{
  //-----------------------------------------------------------------------
  /* update uu and rr */
  //-----------------------------------------------------------------------
...
(const int lane, jnode * RESTRICT pi, const int idx, pos4seb * RESTRICT pos, dat4seb * RESTRICT mem,
...
(const int lane, jnode * RESTRICT pi, pos4seb * RESTRICT pos, const real4 cen, dat4seb * RESTRICT aff,
 int * RESTRICT rank, dat4seb * RESTRICT mem, real * RESTRICT qq, real * RESTRICT rr)
{
  //-----------------------------------------------------------------------
...
(const int lane, jnode * RESTRICT pi, pos4seb * RESTRICT pos, const int idx,
 int * RESTRICT rank, dat4seb * RESTRICT mem, volatile real * RESTRICT qq, real * RESTRICT rr
#ifndef USE_WARP_SHUFFLE_FUNC
...
(const int lane, jnode * RESTRICT pi, pos4seb * RESTRICT pos, real4 * RESTRICT cen, real * RESTRICT qq, real * RESTRICT rr
#ifndef USE_WARP_SHUFFLE_FUNC
 , volatile uint_real * RESTRICT smem, volatile int * RESTRICT sidx, const int tidx, const int head
#endif//USE_WARP_SHUFFLE_FUNC
)
