...
static const real vm31x = CAST_D2R(180.25164984054564);/**< HST + Gaia DR2 by van der Marel et al. (2019) */
static const real vm31y = CAST_D2R(-139.78699375389255);/**< HST + Gaia DR2 by van der Marel et al. (2019) */
