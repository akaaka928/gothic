...
#define USE_WARP_REDUCE_FUNC_TIME
...
#   if  defined(USE_WARP_REDUCE_FUNC_TIME) && !defined(ENABLE_WARP_REDUCE_FUNC)
#undef          USE_WARP_REDUCE_FUNC_TIME
#endif//defined(USE_WARP_REDUCE_FUNC_TIME) && !defined(ENABLE_WARP_REDUCE_FUNC)
