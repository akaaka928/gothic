        ...
        for kk in range(kind):
            ...
            for ff in range(Nfield):
                ...
                for mm in range(Nmodel):
                    xy_map[kk][ff][mm] = h5file[folder + field[ff].decode('utf-8') + '-' + model[mm].decode('utf-8') + '-map']
                    yv_map[kk][ff][mm] = h5file[folder + field[ff].decode('utf-8') + '-' + model[mm].decode('utf-8') + '-vel']
